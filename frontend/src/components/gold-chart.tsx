...
export function GoldChart() {
  return (
    <div className="bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-sm border border-gray-700 shadow-2xl rounded-xl p-6 w-full max-w-4xl">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-white mb-2">黄金价格走势</h2>
        <p className="text-gray-400">最近30天黄金价格（美元/盎司）</p>
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-gray-800/50 p-4 rounded-lg">
          <p className="text-gray-400 text-sm">30天最高</p>
          <p className="text-xl font-bold text-green-400">
            ${Math.max(...goldData.map(d => d.high)).toFixed(2)}
          </p>
        </div>
        <div className="bg-gray-800/50 p-4 rounded-lg">
          <p className="text-gray-400 text-sm">30天最低</p>
